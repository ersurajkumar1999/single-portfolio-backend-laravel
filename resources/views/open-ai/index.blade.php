...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function setChatPreloading(status) {
          $('.chat-preloading').css({'display': status?'block':'none'});
        }
        function toggleLoading(isLoading) {
          if(isLoading){
            $('.send-msg-btn-loading').css({'display': isLoading?'block':'none'});
            $('.send-msg-btn').css({'display': isLoading?'none':'block'});
          }else{
            $('.send-msg-btn-loading').css({'display': isLoading?'none':'none'});
            $('.send-msg-btn').css({'display': isLoading?'block':'none'});
          }
        }
