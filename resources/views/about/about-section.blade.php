<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <form method="POST" action="{{route('about.create', $about->id)}}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-2">
                            <div>
                                ...
                                <input type="file" class="form-control {{ $errors->has('image') ? 'is-invalid' : '' }}" id="about-image" name="image" />
                                @if ($errors->has('image'))
                                <span class="invalid-feedback">
                                    {{ $errors->first('image') }}
                                </span>
                        ...
                        <div class="col-md-12">
                            <div>
                                ...
                                <textarea name="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" id="description" placeholder="Description">
                                {{ $about->description }}
                                </textarea>
