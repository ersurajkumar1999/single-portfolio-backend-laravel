<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            <h5 class="card-header">Service Information</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div>
                                ...
                                <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" id="title" name="title" value="{{ $service->title }}" placeholder="Title" />
                                @if ($errors->has('title'))
