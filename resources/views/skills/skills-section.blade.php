<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            <h5 class="card-header">Skill Information</h5>
            <form method="POST" action="{{route('skills.create')}}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div>
                                ...
                                <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" id="title" name="title" value="{{ $skill->title }}" placeholder="Title" />
                                @if ($errors->has('title'))
